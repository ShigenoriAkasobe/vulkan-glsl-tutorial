...
private:
    ...
    void initWindow() {
        ...
        window = glfwCreateWindow(kWindowWidth, kWindowHeight, "Step04_Transform", nullptr, nullptr);
        if (!window) {
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile(shaderPath("transform.vert.spv"));
        auto fragShaderCode = readFile(shaderPath("transform.frag.spv"));
    ...
    void createUniformBuffers() {
        const VkDeviceSize bufferSize = sizeof(Mat4);
    ...
    void updateUniformBuffer(uint32_t imageIndex) {
        ...
        Mat4 mvp = mat4RotationZ(t);
        std::memcpy(uniformBufferMapped[imageIndex], &mvp, sizeof(mvp));
    }
