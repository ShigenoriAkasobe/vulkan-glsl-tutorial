...
private:
    ...
    void initWindow() {
        ...
        window = glfwCreateWindow(kWindowWidth, kWindowHeight, "Step01_MinimalTriangle", nullptr, nullptr);
        if (!window) {
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile(shaderPath("triangle.vert.spv"));
        auto fragShaderCode = readFile(shaderPath("triangle.frag.spv"));
